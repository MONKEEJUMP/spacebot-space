...
// Alpha Decompose -> qwen3.6-plus | Wingmen -> qwen3.5-122b-a10b | Alpha Fuse -> qwen-flash
...
export const DORYLUS_CONFIG = {
  ...
  // OLD: endpoint: 'https://dashscope-intl.aliyuncs.com/compatible-mode/v1/chat/completions',
  endpoint: 'https://openrouter.ai/api/v1/chat/completions',

  // Models — 3 tiers for different roles
  // OLD: alphaDecomposeModel: 'qwen3.6-plus',
  alphaDecomposeModel: 'openrouter/owl-alpha',     // Alpha 1: dispatcher/compiler
  // OLD: wingmanModel: 'qwen3.5-122b-a10b',
  wingmanModel: 'openrouter/owl-alpha',       // Wingmen: 122B params, 10B active
  // OLD: alphaFuseModel: 'qwen-flash',
  alphaFuseModel: 'openrouter/owl-alpha',             // Alpha 2: trillion-parameter fuser
  ...
  wingmanKeyIndexes: [1, 2, 3, 4, 5, 6],  // keys[1-5] = Wingmen 1-5
  ...
  tavilyKeys: [
    ...
    process.env.TAVILY_KEY_W6 || '',   // Wingman 6
  ],
