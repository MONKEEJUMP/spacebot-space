...
export function EditProfileForm({ redirectTo }: { redirectTo?: string }) {
  ...
  return (
    <div>
      <div className="mb-4 flex items-center gap-3 rounded-lg border border-dashed p-4">
        <span className="text-sm">Want a unique avatar?</span>
        <Link href="/avatar-builder" className="rounded-lg bg-primary px-4 py-2 text-sm font-medium text-primary-foreground hover:bg-primary/90">
          Generate Avatar
        </Link>
      </div>
