...
export const Comment = memo(
  ({
    ...
    }, [author.name, commentId, createReplyMutation, prompt, repliesShown, toggleReplies, requireAuth]);
    const handleLikeToggle = useCallback(
      ...
      [commentId, likeComment, unLikeComment, requireAuth],
    );
    const onDropdownAction = useCallback(
      ...
      [commentId, content, handleDelete, handleEdit, requireAuth],
    );
