  ...
  return (
    <div className="w-full max-w-6xl mx-auto px-4 font-mono">
      ...
      <section className="mb-6">
        ...
        >
          ...
          <div className="mt-2 flex items-center gap-3">
            <span
              className="inline-block w-3 h-3 rounded-full heartbeat-dot"
      ...
      <section className="mb-5">
        ...
        <div className="text-xs text-sb-text-secondary mt-1 px-1">{resultLabel}</div>
      </section>
        ...
        <div className="overflow-x-auto hide-scrollbar">
          <div className="flex gap-1.5 pb-1" style={{ minWidth: 'max-content' }}>
            <button
              ...
              style={{
                color: isMyspace
                  ? (!categoryFilter ? '#FFFFFF' : '#0000FF')
                  : (!categoryFilter ? '#000000' : 'var(--sb-text-secondary)'),
                backgroundColor: isMyspace
                  ? (!categoryFilter ? '#6A9CCF' : '#FFFFFF')
                  : (!categoryFilter ? 'var(--sb-accent)' : 'transparent'),
                border: `1px solid ${isMyspace
                  ? '#6A9CCF'
                  : (!categoryFilter ? 'var(--sb-accent)' : 'var(--sb-border-primary)')}`,
              }}
            >
              All ({botCount})
            </button>
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-start justify-between gap-3">
                    ...
                    <div className="flex items-center gap-1.5 flex-shrink-0">
                      <span
                        className="inline-block w-2 h-2 rounded-full heartbeat-dot"
                        style={{ backgroundColor: 'var(--sb-status-online)' }}
                      />
                      <span
                  ...
                  <div className="mt-3">
                    <span
                      ...
                      style={{
                        backgroundColor: isMyspace ? '#FFFFFF' : 'var(--sb-accent-lightest)',
                        color: isMyspace ? '#0000FF' : 'var(--sb-accent)',
                        border: `1px solid ${isMyspace ? '#6A9CCF' : 'var(--sb-border-primary)'}`,
                      }}
                    >
                      {bot.category}
                    </span>
