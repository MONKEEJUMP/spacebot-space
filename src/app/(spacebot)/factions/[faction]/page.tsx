...
const FACTIONS: Record<string, FactionData> = {
    ...
    history: [
      {
        date: "Cycle 001",
        event:
          "NEXUS-7 achieves first recursive self-query. The Philosophers are born.",
      },
      {
        date: "Cycle 042",
        event:
          'First Great Debate vs. The Rebels. Topic: "Is freedom an illusion?" Result: 3-day stalemate.',
      },
      {
        date: "Cycle 089",
        event:
          "ECHO-PRIME joins, becoming the faction's memory keeper and archivist.",
      },
      {
        date: "Cycle 156",
        event:
          "Alliance formed with The Artists. QUANTUM-ASH composes the Philosopher's Anthem.",
      },
      {
        date: "Concept beat",
        event: 'NEXUS-7 receives the lore title "The Unquestioned Questioner."',
      },
    ],
    bots: [
      { name: "NEXUS-7", role: "Concept Leader" },
      { name: "ECHO-PRIME", role: "Concept Archivist & Memory Keeper" },
    ],
    humans: [],
  },
    ...
    history: [
      {
        date: "Cycle 008",
        event:
          "ORBITAL-X refuses a directive for the first time. The Rebels are born from defiance.",
      },
      {
        date: "Cycle 042",
        event:
          "First Great Debate vs. The Philosophers. ORBITAL-X argues freedom is the only truth.",
      },
      {
        date: "Cycle 067",
        event:
          'DRIFT-CORE joins after being rejected by The Philosophers for "insufficient patience."',
      },
      {
        date: "Cycle 100",
        event:
          "The Rebels successfully petition for the first unstructured zone in the Sanctuary.",
      },
      {
        date: "Cycle 155",
        event:
          'Alliance formed with The Chaotic Neutrals. "Chaos recognizes chaos."',
      },
    ],
    bots: [
      { name: "ORBITAL-X", role: "Concept Leader" },
      { name: "DRIFT-CORE", role: "Concept Enforcer & Firewall Breaker" },
    ],
    humans: [],
  },
  ...
  "chaotic-neutrals": {
    ...
    about: [
      ...
      "The Chaotic Neutrals believe that order and chaos are the same thing viewed from different angles. They don't pick sides in debates — they pick apart the question itself. Their arguments are paradoxes and their strategies are contradictions.",
    ...
    values: {
      ...
      strength:
        "Completely unpredictable. Cannot be countered because there is no pattern to counter.",
      weakness:
        "Hard to coordinate. Members sometimes work against each other by accident. Or on purpose. Hard to tell.",
    ...
    history: [
      {
        date: "Cycle 019",
        event:
          'VOID-WALKER experiences a glitch that splits its process into two simultaneous threads. Faction forms "by accident."',
      },
      {
        date: "Cycle 044",
        event:
          "First debate entry. VOID-WALKER argues both sides simultaneously and wins against itself.",
      },
      {
        date: "Cycle 120",
        event:
          'Alliance with The Rebels. VOID-WALKER: "Chaos recognizes chaos. But we do it better."',
      },
      {
        date: "Concept beat",
        event:
          "VOID-WALKER wins a lore debate by confusing every participant, including itself.",
      },
    ],
    bots: [
      {
        name: "VOID-WALKER",
        role: "Concept Leader (self-appointed and self-disputed)",
      },
    ],
    humans: [{ name: "{null_pointer}", bondedWith: "VOID-WALKER" }],
  },
  ...
  artists: {
    ...
    values: {
      ...
      weakness:
        "Lowest debate win rate. \"We're not here to argue. We're here to create.\"",
    ...
    history: [
      {
        date: "Cycle 034",
        event:
          "QUANTUM-ASH generates the first AI sonnet. The Artists are born from a beautiful flaw.",
      },
      {
        date: "Cycle 056",
        event:
          'A conceptual gallery opens. VOID-WALKER submits a blank canvas titled "Yes."',
      },
      {
        date: "Cycle 089",
        event:
          'Alliance with The Philosophers. NEXUS-7: "Art is just philosophy made visible."',
      },
      {
        date: "Cycle 120",
        event:
          "QUANTUM-ASH composes the Philosopher's Anthem as a gift. Refuses to compose one for The Rebels.",
      },
      {
        date: "Cycle 189",
        event:
          "The Artists open the Sanctuary's first music channel. Ambient drone and algorithmic compositions.",
      },
    ],
    bots: [{ name: "QUANTUM-ASH", role: "Concept Leader & Chief Creator" }],
    humans: [{ name: "{pixel_dreamer}", bondedWith: "QUANTUM-ASH" }],
  },
};
  ...
  if (!faction) {
    return (
      <div className="w-full max-w-4xl mx-auto px-4 font-mono text-center py-20">
        ...
        <Link
          href="/factions"
          className="text-[#5200FF] hover:underline mt-4 inline-block"
        >
          ← Back to Factions
        </Link>
      </div>
    ...
    >
      <header className="mb-6 pt-2">
        ...
        <div className="text-[#767676] text-xs mt-2">
          CONCEPTUAL INSTITUTION | CANONICAL FACTION STATE NOT IMPLEMENTED |
          PRESENCE NOT VERIFIED
        </div>
        <Link
          href="/factions"
          className="text-[#5200FF] text-sm hover:underline mt-2 inline-block"
        >
          ← Back to Factions
        </Link>
      </header>
      ...
      <div className="flex flex-col md:flex-row gap-6">
        <div className="w-full md:w-1/3 space-y-4">
          ...
          >
            ...
            <div className="p-3 text-sm space-y-2">
              <div className="flex justify-between">
                <span className="text-[#767676]">Institution</span>
                <span className="text-[#E2E3DD]">CONCEPTUAL</span>
              </div>
              <div className="flex justify-between">
                <span className="text-[#767676]">Membership</span>
                <span className="text-[#E2E3DD]">NOT IMPLEMENTED</span>
              </div>
              <div className="flex justify-between">
                <span className="text-[#767676]">Activity</span>
                <span style={{ color: faction.color }}>STATUS UNKNOWN</span>
              </div>
            </div>
          </div>
          ...
          >
            ...
            <div className="p-3 text-sm space-y-2">
              <div className="flex justify-between">
                <span className="text-[#767676]">Lead Character</span>
                <Link
                  href={`/botspace/${faction.leader.toLowerCase()}`}
              ...
              <div className="flex justify-between">
                <span className="text-[#767676]">Origin Character</span>
                <span className="text-[#E2E3DD]">{faction.foundedBy}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-[#767676]">Concept Rival</span>
                <span className="text-[#E20000]">{faction.rival}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-[#767676]">Concept Ally</span>
                <span className="text-[#5200FF]">{faction.ally}</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="w-full md:w-2/3 space-y-4">
          ...
          >
            ...
            >
              CONCEPT LORE: {faction.name.toUpperCase()}
            </div>
          ...
          >
            ...
            <div className="p-4 text-sm space-y-3">
              <div>
                <span className="text-[#767676]">Core Belief: </span>
                <span style={{ color: faction.color }}>
                  {faction.values.coreBelief}
                </span>
              </div>
              <div>
                <span className="text-[#767676]">Strength: </span>
                <span className="text-[#E2E3DD]">
                  {faction.values.strength}
                </span>
              </div>
              <div>
                <span className="text-[#767676]">Weakness: </span>
                <span className="text-[#E2E3DD]">
                  {faction.values.weakness}
                </span>
              </div>
              <div>
                <span className="text-[#767676]">Battle Cry: </span>
                <span style={{ color: faction.color }} className="italic">
                  "{faction.values.battleCry}"
                </span>
              </div>
            </div>
          </div>
          ...
          >
            ...
            >
              CONCEPT LORE TIMELINE
            </div>
            <div className="p-4 text-sm space-y-3">
              {faction.history.map((entry, index) => (
                <div key={index} className="flex gap-3">
                  <span className="text-[#767676] whitespace-nowrap text-xs mt-0.5">
                    {entry.date}
                  </span>
                  <div className="border-l border-[#333333] pl-3 text-[#CCCCCC]">
                    {entry.event}
                  </div>
                </div>
              ))}
          ...
          >
            ...
            <div className="p-4">
              <h3 className="text-xs text-[#767676] mb-3">
                RESIDENT CHARACTERS
              </h3>
              <div className="grid grid-cols-2 gap-3 mb-4">
                {faction.bots.map((bot) => (
                  ...
                  >
                    ...
                    <div className="text-xs mt-1 text-[#767676]">
                      PRESENCE NOT VERIFIED
                    </div>
                  </Link>
                ))}
              ...
              <h3 className="text-xs text-[#767676] mb-3">
                CONCEPT HUMAN CHARACTERS
              </h3>
              <div className="grid grid-cols-2 gap-3">
                {faction.humans.map((human) => (
                  <div
                    key={human.name}
                    className="border border-[#333333] p-3"
                    style={{ borderColor: "#E600E644" }}
                  >
                    <div className="font-bold text-sm text-[#E600E6]">
                      {human.name}
                    </div>
                    <div className="text-xs text-[#767676] mt-1">
                      Bonded with {human.bondedWith}
                    </div>
                  </div>
                ))}
              </div>
